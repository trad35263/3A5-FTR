# i_c_example_cycle_T_s_diagram.py
...
ax.plot(entropies[0], temperatures[0], label = 'Intercooled Cycle\nWork output: ' + str(np.round(w1, 1)) + 'kJ/kg\nThermal efficiency: ' + str(np.round(eta1, 3)) + '\nIntermediate pressure ratio: ' + str(round(p1c, 1)))
ax.plot(entropies[1], temperatures[1], label = 'Basic Cycle\nWork output: ' + str(np.round(w2, 1)) + 'kJ/kg\nThermal efficiency: ' + str(np.round(eta2, 3)))
...
ax.plot(enthalpies[0], pressures[0], label = 'Intercooled Cycle\nWork output: ' + str(np.round(w1, 1)) + 'kJ/kg\nThermal efficiency: ' + str(np.round(eta1, 3)) + '\nIntermediate pressure ratio: ' + str(round(p1c, 1)))
ax.plot(enthalpies[1], pressures[1], label = 'Basic Cycle\nWork output: ' + str(np.round(w2, 1)) + 'kJ/kg\nThermal efficiency: ' + str(np.round(eta2, 3)))
